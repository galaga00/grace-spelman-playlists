...
- The directory intentionally excludes obsolete partial/test playlists. Current verified inventory: 149 complete playlists and 4,450 playable tracks; six retired source links are shown only as a summary count.
...
4. Confirm the rendered stats are 149 complete playlists, 4,450 tracks, and six retired links until new production newsletters change the inventory.
